...
import { DeleteSaleData, DeleteSaleItem } from "../model/deleteData";

const DeleteSale = ({ ids }) => {
      ...
      >
        <div className="flex justify-center h-full w-full">
          <div
            ...
            onClick={handleToggle}
          ></div>
          <div className="absolute top-48 bg-white rounded-lg shadow dark:bg-gray-700">
            <button
              type="button"
